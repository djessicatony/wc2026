...
## v3 результаты (фича Elo — сила соперника)

Гипотеза: модель недооценила Бразилию, потому что игнорировала силу соперников. Добавили рейтинг Elo (учитывает, кого ты обыграл). **Подтверждено замером.**

| | бэктест |
|---|---|
| v1 (форма, 7 фич) | 0.651 |
| **v3 (форма + Elo, 9 фич)** | **0.712** (+6 пунктов) |

- Прогноз Бразилии: 29.1% → 36.8% (поехал к рыночным 59%).
- Главный урок: **одна хорошая фича (+6 пунктов) побила смену модели на XGBoost (0 пунктов).** Хорошие фичи > умные модели.
- Brazil Elo 1948 vs Morocco Elo 1906 — разрыв мал, Морокко объективно сильна; правда, возможно, между нашими 37% и рыночными 59%.
